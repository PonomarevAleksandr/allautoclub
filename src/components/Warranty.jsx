...
const Warranty = ({ warrantyContent, openModal }) => {
    const [isVisible, setIsVisible] = useState(false);
    const [isPaused, setIsPaused] = useState(false);
    useEffect(() => {
        const handleScroll = () => {
            const section = document.getElementById("warranty-section");
    ...
    return (
        <div className="w-full bg-neutral-900 py-16 px-6" id="warranty-section">
            <motion.div
            ...
            >
                ...
                <div id="offer" className="w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
                    <h2 className="text-3xl sm:text-2xl md:text-5xl font-extrabold text-white mb-4 sm:text-center lg:text-left">
                        ...
                        <span className="bg-gradient-to-r from-orange-400 to-red-500 text-transparent bg-clip-text">
                            {warrantyContent.highlightedTitle}
                        </span>
                    </h2>
