...
const Calculator = ({regions}) => {
    ...
    return (
        <motion.div
            className="w-full max-w-[400px] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] p-6 sm:p-8 bg-gray-900/50 rounded-lg shadow-lg border border-gray-700 backdrop-blur-md mt-10"
        ...
        >
            <div className="max-w-full mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select
                            ...
                            className="w-full p-2 sm:p-3 bg-gray-700 text-neutral-200 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-500"
                        >
                ...
                {/* Прибыль */}
                <div className="mt-8 p-4 sm:p-6 bg-gray-700 rounded-lg shadow-md border border-gray-600 text-center">
