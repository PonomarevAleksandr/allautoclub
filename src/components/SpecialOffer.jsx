...
import animationData from "../assets/animations/14_REDGRAPH.json";

const SpecialOffer = ({ specialOfferContent, openModal}) => {
    ...
    return (
        <div className="w-full bg-neutral-900 py-16 px-6 text-white" id="special-offer-section">
            <motion.div
            ...
            >
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
                    <h2 className="text-3xl sm:text-2xl md:text-5xl font-extrabold mb-4 sm:text-center lg:text-left">
                        {specialOfferContent.title}{" "}
                        <span className="bg-gradient-to-r from-orange-400 to-red-500 text-transparent bg-clip-text">
                            {specialOfferContent.highlightedTitle}
                        </span>
                    </h2>
                    <p className="text-lg sm:text-base text-neutral-400 mb-6">
                        {specialOfferContent.description}
                    </p>
                    <button
                        onClick={openModal}
                        className="bg-orange-600 hover:bg-orange-700 text-white py-3 px-6 rounded-lg text-lg transition duration-200 mb-4"
                    >
                        {specialOfferContent.buttonText}
                    </button>
                </div>

                {/* Правый блок с анимацией Lottie */}
