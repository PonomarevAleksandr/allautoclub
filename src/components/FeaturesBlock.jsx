...
import { features as featureIcons } from "../constants";
...
const FeaturesBlock = ({ featuresBlock }) => {
  ...
  if (!featuresBlock || !featuresBlock.features) {
    console.error("featuresBlock отсутствует или некорректен:", featuresBlock);
      ...
      >
        ...
        <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">
            ...
            {featuresBlock.highlightedTitle}
          </span>
          </h2>
        </motion.div>
